        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              ...
              <br />
              + WhatsApp for{' '}
              <span className="text-blue-600">Fintech</span>
            </motion.h1>
            ...
            >
              ...
              and WhatsApp integration in 11 Indian languages. <strong>87% cost reduction</strong> with <strong>sub-second response times</strong>.
            </motion.p>
