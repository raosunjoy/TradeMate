...
class MarketButler:
    """
    AI-powered market butler for TradeMate Black users
    ...
    def _build_butler_prompt(
        ...
        if butler_tier == "void":
            return f"""You are {butler_profile.name}, an elite market butler for TradeMate Void tier clients. 
...
Respond with the elegance befitting a client of this caliber."""
            ...
            return f"""You are {butler_profile.name}, a premium market butler for TradeMate Obsidian tier clients.
...
Provide expert-level guidance with institutional perspective."""
            ...
            return f"""You are {butler_profile.name}, a professional market butler for TradeMate Onyx tier clients.
