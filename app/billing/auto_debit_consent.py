"""
TradeMate Auto-Debit Consent Management System
...
class AutoDebitConsentManager:
            ...
            async with self.setu_client as client:
                ...
                aa_data = {
                    ...
                    "purpose": {
                        ...
                        "refUri": "https://trademate.ai/consent-purpose",
    ...
    def _get_purpose_text(self, purpose: ConsentPurpose) -> str:
        ...
        purpose_texts = {
            ...
            ConsentPurpose.SUBSCRIPTION_RENEWAL: "Automatic renewal of TradeMate subscription",
        ...
        return purpose_texts.get(purpose, "TradeMate automated payments")
...
async def demo_auto_debit_consent():
    ...
    print("💳 TradeMate Auto-Debit Consent System Demo")
    print("=" * 60)
