...
Or type 'market' for overall market status! 🌍""",
    ...
    async def _handle_greeting(self, user_id: str, user_profile: UserProfile) -> Dict[str, Any]:
        ...
        return {
            'type': 'text',
            'content': f"""Hello {user_name}! 👋 Welcome to TradeMate! 
...
Choose what you'd like help with:""",
    ...
    async def _handle_general_conversation(
        ...
        system_prompt = """You are TradeMate, an AI assistant for a WhatsApp-based trading platform in India. 
