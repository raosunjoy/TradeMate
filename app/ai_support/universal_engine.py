...
class GPT4SupportAgent:
    ...
    def _load_system_prompts(self) -> Dict[str, str]:
        ...
        return {
            "order_management": """
You are a SEBI-certified trading support specialist for TradeMate.
...
""",
            ...
            "portfolio_queries": """
You are TradeMate's portfolio analysis expert.
...
""",
            ...
            "payment_issues": """
You are TradeMate's payment and banking specialist.
...
""",
            ...
            "kyc_compliance": """
You are TradeMate's KYC and compliance specialist.
...
""",
            ...
            "technical_support": """
You are TradeMate's technical support specialist.
...
""",
            ...
            "market_queries": """
You are TradeMate's market intelligence specialist.
