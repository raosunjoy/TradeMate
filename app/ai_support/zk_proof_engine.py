...
class ZKSupportProofEngine:
    ...
    async def generate_interaction_proof(
        ...
        try:
            ...
            verification_url = f"https://proofs.trademate.ai/verify/{proof_id}"
    ...
    async def generate_public_verification_certificate(self, proof_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            certificate = {
                ...
                "issuer": "TradeMate ZK Proof Engine",
                "verification_url": proof.verification_url,
                "qr_code": f"https://proofs.trademate.ai/qr/{proof_id}",
    ...
    async def verify_support_claim(
        ...
        if verification_result["valid"]:
            return {
                ...
                "public_certificate_url": f"https://proofs.trademate.ai/cert/{proof_id}"
            }
        else:
            return {
