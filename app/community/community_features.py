...
class CommunityEngine:
    ...
    async def register_user(self, user_data: Dict[str, Any]) -> User:
        ...
        await self._award_achievement(user_id, BadgeType.FIRST_INVESTMENT, "Welcome to TradeMate!", 100)
    ...
    async def create_challenge(self, challenge_data: Dict[str, Any]) -> Challenge:
        ...
        challenge = Challenge(
            ...
            created_by=challenge_data.get("created_by", "TradeMate")
        )
