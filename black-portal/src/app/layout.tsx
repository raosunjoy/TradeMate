...
export const metadata: Metadata = {
  title: 'TradeMate Black Portal - For Those Who Trade Beyond Charts',
  ...
  authors: [{ name: 'TradeMate Black Team' }],
  robots: 'noindex, nofollow', // Keep portal mysterious
  openGraph: {
    title: 'TradeMate Black Portal',
    description: 'For Those Who Trade Beyond Charts',
    type: 'website',
    url: 'https://black.trademate.ai',
    siteName: 'TradeMate Black Portal',
    images: [
      {
        url: 'https://black.trademate.ai/og-image.jpg',
        width: 1200,
        height: 630,
        alt: 'TradeMate Black Portal'
      }
    ]
  },
  twitter: {
    ...
    title: 'TradeMate Black Portal',
    description: 'For Those Who Trade Beyond Charts',
    images: ['https://black.trademate.ai/twitter-image.jpg']
  },
  viewport: {
    width: 'device-width',
    initialScale: 1,
